...
const Scan: Component<ComponentProps<'svg'>> = (props) => {
  return (
    <svg
...
<path d="M5 13C4.44772 13 4 12.5523 4 12V12C4 11.4477 4.44772 11 5 11L19 11C19.5523 11 20 11.4477 20 12V12C20 12.5523 19.5523 13 19 13L5 13Z" fill="black"/>
    </svg>
  );
};
export default Scan;